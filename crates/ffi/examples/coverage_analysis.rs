use ffi::{DependencyConfig, PublicItem, extract_crate_spec};
...
fn analyze_extraction(spec: &ffi::CrateSpec, expected_core_items: usize) {
...
fn is_std_trait_impl(path: &ffi::RustPath) -> bool {
